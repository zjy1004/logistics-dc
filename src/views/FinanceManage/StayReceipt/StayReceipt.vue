          ...
          <div class="form-con">
            <el-form :inline="true" ref="form" :model="form" class="demo-form-inline" label-width="100px">
              <div class="common-search">
                <el-form-item label="交款人:" prop="payUser">
                  <el-select v-model.number="form.payUser" placeholder="请选择交款人" clearable filterable>
                    <el-option
...
export default {
  ...
  methods: {
    ...
    getReaciver (val) { // 查询物流公司下所有员工包括物流公司管理员
      StayReceiptAjax.QueryPayUser(val).then(res => {
        if (res.code === 200) {
    ...
    queryList (type) {
      ...
      StayReceiptAjax.QueryList(queryParam).then(response => {
    ...
    exportExcel () {
      ...
      exportParams.url = '/dc/waybill/collect/list/export'
