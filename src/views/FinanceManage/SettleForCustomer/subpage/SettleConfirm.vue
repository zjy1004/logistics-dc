<template>
  <el-dialog :before-close="closeFormDialog" class="settle-confirm-dialog" :close-on-click-modal="closeClickModal" :width="width" :title="title" :visible.sync="dialogVisibleSelf">
    <div>
