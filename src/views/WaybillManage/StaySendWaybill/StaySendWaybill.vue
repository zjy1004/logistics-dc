            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  ...
                  <a class="edit" v-if="scope.row.cancelFlag === 0" href="javascript:;" type="text" size="small" @click="cancel(scope.row)">取消</a>
                </template>
              </el-table-column>
            </el-table>
          </div>
...
export default {
  ...
  methods: {
    ...
    // 查看
    check (row) {
      this.$router.push({name: 'WaybillDetail', query: {waybillTitle: '待发货运单', waybillId: row.waybillId}})
    }
  }
}
</script>
